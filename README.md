...
- Barra de progreso: mientras suena, una barra semitransparente del color de la etiqueta barre la cara del pad de izquierda a derecha al ritmo real del audio (duración por decode local, con respaldo de OBS).
