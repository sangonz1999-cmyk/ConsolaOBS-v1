...
## Índice
**Núcleo:** [0. ¿Qué es?](#sec-0) · [1. Requisitos y dependencias](#sec-1) · [2. Arquitectura general (ventana Tk, dos clientes OBS, hilos)](#sec-2) · [3. Conexión a OBS (config, estado, formato de datos)](#sec-3) · [4. Modelo de datos / estado global](#sec-4) · [5. Eventos de OBS en tiempo real (bidireccional)](#sec-5)

**Audio:** [6. Medidores VU tipo LED + medidores de niveles (VU meters)](#sec-6) · [7. Saturación / "rojo" en el medidor](#sec-7) · [8. Fader/fuentes (tarjetas, mute, monitoreo, arrastre, menú)](#sec-8) · [8b. Eliminar fuente (clic derecho > Eliminar fuente…)](#sec-8b) · [8c. Quitar de todas las escenas (clic derecho)](#sec-8c) · [9. Fuentes "principales" (favoritos que se generan siempre)](#sec-9) · [10. Filtros de audio (crear, editar, ajustes en tiempo real)](#sec-10) · [10b. Propiedades de fuente (clic derecho > Propiedades)](#sec-10b) · [11. Soundboard (pads de sonido, arrastre, miniaturas, configuración)](#sec-11) · [11b. Agregar fuente (clic derecho en el panel > Agregar fuente)](#sec-11b) · [11c. Vaciar pad vs Eliminar pad](#sec-11c)

**Interfaz:** [12. Cabecera, panel de fuentes, paneles drag con arrastre reordenable](#sec-12) · [13. Redimensionado responsive (factor de escala, velo, supersampling)](#sec-13) · [14. Persistencia (config JSON)](#sec-14) · [15. Estética y dibujo a mano (sombra, gradiente, engranaje, iconos)](#sec-15) · [16. Windows: anti-parpadeo nativo (WM_SETREDRAW, pincel de fondo)](#sec-16) · [17. Flux de arranque / cierre](#sec-17) · [18. Consideraciones de hilos y concurrencia](#sec-18) · [19. Cómo compilar el .exe](#sec-19)
...
- En Moderna el fader es estilo OBS (`_FaderOBS`): pista negra angosta prerenderizada con extremos redondos suaves del mismo largo que el medidor, relleno azul opaco hasta el final, pastilla contenida entre los extremos sin sobrepasarlos y marcas perpendiculares cada 10 dB (0 a -50).
...
- Barra de progreso: mientras suena, una barra semitransparente del color de la etiqueta barre la cara del pad de izquierda a derecha al ritmo real del audio (duración por decode local, con respaldo de OBS), con las esquinas redondeadas de la cara. Sin OBS, pasada la duración la luz se apaga sola por reloj.
